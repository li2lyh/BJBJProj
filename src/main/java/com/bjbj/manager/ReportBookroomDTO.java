...
public class ReportBookroomDTO {
	...
	public String getrepoter_nickname() {
		return reporter_nickname;
	}
	public void setrepoter_nickname(String repoter_nickname) {
		this.reporter_nickname = repoter_nickname;
	}
	@Override
	public String toString() {
		return  room_id + room_title + report_content + warning_count + report_date + report_detail + report_action + reporter_nickname;
	}
