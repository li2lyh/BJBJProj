...
public String toString() {
	return "ReviewDTO [review_no=" + review_no + ", review_title=" + review_title + ", email=" + email + ", book_title="
			+ book_title + ", nickname=" + nickname + ", written_date=" + written_date + ", content=" + content
			+ ", views=" + views + ", img_id=" + img_id + "]";
}
