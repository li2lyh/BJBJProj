...
<body>
		...
		<div class="registerBox">
			...
			<form id="signupForm" action="/member/signUp" method="post">
				...
				<div class="row">
					...
					<div class="col-3">
						<button type="button" id="confirmEmail" class="btn btn-outline-secondary">중복확인</button>
					</div>
				</div>
				<%-- 빈칸 --%>
				<div class="row blankBox">
				...
				<div class="row">
					...
					<div class="col-3">
						<button type="button" id="confirmNickname" class="btn btn-outline-secondary">중복확인</button>
					</div>
				</div>
					<%-- 빈칸 --%>
				<div class="row blankBox">
				...
				<div class="row">
					...
					<div class="col-3 confirmPhone">
						<button type="button" id="verifyPhoneBtn" class="btn btn-outline-secondary">인증하기</button>
					</div>
				</div>
				...
				<div class="row verifyPhone d-none">
					<div class="col-9 p-0">
						<input type="text" class="form-control" id="verifyNum" maxlength="6">
					</div>
					<div class="col-3 checkPhone p-0">
						<button type="button" id="completeBtn" class="btn btn-outline-secondary">확인</button>
					</div>
				</div>
				
				<!-- 제출 버튼 -->
				<div class="submitBtn row">
					<button type="button" id="signupBtn" class="btn btn-outline-secondary">가입하기</button>
				</div>
			</form>
	...
	<script>
			...
			$.ajax({
				...
				, success : function(data){
					...
					$("#completeBtn").on("click", function(){
						console.log($("#phone").val());
						console.log(data);
						console.log($("#phoneVerify").val());
						if($("#phoneVerify").val() == data.substr(1,5)){
							alert("완료되었습니다.");
						}
					})
				} 
		...
		*/
		...
		$("#signupBtn").on("click", function(){ // 회원가입 제출 유효성 검사
