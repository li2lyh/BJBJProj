...
<body>
	<form action="/club/write" id="submitForm" method="post" enctype="multipart/form-data">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col">
					<select class="form-select" id="meet_week" name="meet_week" aria-label="Default select example">
			...
			<div class="row">
				...
				<div class="col">
                    ...
                    <select class="form-select" id="room_people" name="room_people" aria-label="Default select example">
			...
			<div class="row">
				...
				<div class="col">
					<input type="text" id="open_date" class="form-control" name="open_date" value="202-07-11" />
				</div>
				
				<div class="col">
					<input type="text" id="close_date" class="form-control" name="close_date" value="202-07-11" />
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col">
			  		<textarea class="form-control" id="room_detail" name="room_detail" rows="5" placeholder="내용을 입력해주세요."></textarea>
				</div>
			</div>
			<div class="row">
				<div class="col d-flex justify-content-end btnBox">
					<p id="p1">* 모집 기간은 등록일로부터 2주입니다</p>
					<button type="button" class="btn btn-secondary m-1 btn-lg" id="toCancle">취소</button>
